        ...
        <div className="border-t border-[#5D4037]/30 pt-6 grid grid-cols-1 md:grid-cols-3 gap-6">
          <div>
            ...
            <div className="text-xs text-[#FFE0B2]/50 space-y-1">
              ...
              <p className="flex items-center gap-1.5"><Mail className="h-3.5 w-3.5" /> aceocheruvugattu@yahoo.in (Temple Office / EO)</p>
              <p className="flex items-center gap-1.5"><Mail className="h-3.5 w-3.5" /> info@cheruvugattu.online</p>
            </div>
          </div>
          <div>
