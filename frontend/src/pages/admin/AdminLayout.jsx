...
import { ShieldCheck, LayoutDashboard, Flame as FlameIcon, Calendar, Clock, BookOpen, Users, LogOut, HandCoins, BedDouble, Newspaper, Camera, Sun, Radio, Mail, MessageSquare, Gift, ScrollText, Settings, Receipt, UserCog } from 'lucide-react';
...
const navItems = [
  ...
  { path: '/admin/stotrams', icon: ScrollText, label: 'Stotrams' },
  ...
  { path: '/admin/aashirvachanam', icon: Gift, label: 'Aashirvachanam' },
