...
async def seed_data():
    ...
    # Seed gallery
    gallery_items = [
        {"id": str(uuid.uuid4()), "title": "Sri Jadala Ramalingeshwara Swamy", "image_url": "/Assets/Sri_Swamy_Varu_1.jpg", "category": "Deities", "media_type": "PHOTO", "active_flag": True, "created_at": datetime.now(timezone.utc).isoformat()},
        {"id": str(uuid.uuid4()), "title": "Sri Swamy Vari Alankaram", "image_url": "/Assets/Sri_Swamy_Varu_2.jpg", "category": "Deities", "media_type": "PHOTO", "active_flag": True, "created_at": datetime.now(timezone.utc).isoformat()},
        {"id": str(uuid.uuid4()), "title": "Sri Parvathi Devi Ammavaru", "image_url": "/Assets/Parvati_Devi_1.jpg", "category": "Deities", "media_type": "PHOTO", "active_flag": True, "created_at": datetime.now(timezone.utc).isoformat()},
        {"id": str(uuid.uuid4()), "title": "Main Temple, Atop the Hill", "image_url": "/Assets/Main_Temple_Full_View_Up_Hill.jpg", "category": "Temple", "media_type": "PHOTO", "active_flag": True, "created_at": datetime.now(timezone.utc).isoformat()},
        {"id": str(uuid.uuid4()), "title": "Sri Parvathi Devi Temple, Foot of the Hill", "image_url": "/Assets/Parvati_Devi_Temple_Panoramic_View_Down_Hill.jpg", "category": "Temple", "media_type": "PHOTO", "active_flag": True, "created_at": datetime.now(timezone.utc).isoformat()},
        {"id": str(uuid.uuid4()), "title": "Parvathi Devi Temple - Aerial View", "image_url": "/Assets/Parvati_Devi_Temple_Top_View_Down_Hill.jpg", "category": "Temple", "media_type": "PHOTO", "active_flag": True, "created_at": datetime.now(timezone.utc).isoformat()},
        {"id": str(uuid.uuid4()), "title": "Moodu Gundlu Shivalingam", "image_url": "/Assets/Mudu_Gundlu_Shivalingam_6.jpg", "category": "Temple", "media_type": "PHOTO", "active_flag": True, "created_at": datetime.now(timezone.utc).isoformat()},
        {"id": str(uuid.uuid4()), "title": "Moodu Gundlu - Abhishekam", "image_url": "/Assets/Mudu_Gundlu_Shivalingam_2.jpg", "category": "Seva", "media_type": "PHOTO", "active_flag": True, "created_at": datetime.now(timezone.utc).isoformat()},
        {"id": str(uuid.uuid4()), "title": "Moodu Gundlu - Alankaram", "image_url": "/Assets/Mudu_Gundlu_Shivalingam_5.jpg", "category": "Seva", "media_type": "PHOTO", "active_flag": True, "created_at": datetime.now(timezone.utc).isoformat()},
        {"id": str(uuid.uuid4()), "title": "Sri Mallikarjuna Swamy", "image_url": "/Assets/Mallikharjuna_Swamy_Down_Hill_1.jpg", "category": "Deities", "media_type": "PHOTO", "active_flag": True, "created_at": datetime.now(timezone.utc).isoformat()},
        {"id": str(uuid.uuid4()), "title": "Sri Subrahmanya Swamy", "image_url": "/Assets/Subrahmanya_Swamy_Down_Hill.jpg", "category": "Deities", "media_type": "PHOTO", "active_flag": True, "created_at": datetime.now(timezone.utc).isoformat()},
        {"id": str(uuid.uuid4()), "title": "Sri Bhadrakali Ammavaru", "image_url": "/Assets/Bhadrakali_Ammavaru_Down_Hill.jpg", "category": "Deities", "media_type": "PHOTO", "active_flag": True, "created_at": datetime.now(timezone.utc).isoformat()},
        {"id": str(uuid.uuid4()), "title": "Sri Veerabhadra Swamy", "image_url": "/Assets/Veerabhadra_Swamy_Down_Hill.jpg", "category": "Deities", "media_type": "PHOTO", "active_flag": True, "created_at": datetime.now(timezone.utc).isoformat()},
        {"id": str(uuid.uuid4()), "title": "Sri Vighneshwara Swamy", "image_url": "/Assets/Ganapati_Swamy_Down_Hill.jpg", "category": "Deities", "media_type": "PHOTO", "active_flag": True, "created_at": datetime.now(timezone.utc).isoformat()},
        {"id": str(uuid.uuid4()), "title": "Sri Anjaneya Swamy", "image_url": "/Assets/Anjaneya_Swamy_1.jpg", "category": "Deities", "media_type": "PHOTO", "active_flag": True, "created_at": datetime.now(timezone.utc).isoformat()},
        {"id": str(uuid.uuid4()), "title": "Brahmotsavam - Dhwajarohanam", "image_url": "/Assets/Brahmotsavam_Dhwajarohanam_1.jpg", "category": "Festival", "media_type": "PHOTO", "active_flag": True, "created_at": datetime.now(timezone.utc).isoformat()},
        {"id": str(uuid.uuid4()), "title": "Brahmotsavam - Pavalimpu Seva", "image_url": "/Assets/Brahmotsavam_Pavalimpu_Seva_Decoratin_1.jpg", "category": "Festival", "media_type": "PHOTO", "active_flag": True, "created_at": datetime.now(timezone.utc).isoformat()},
        {"id": str(uuid.uuid4()), "title": "Brahmotsavam - Pavalimpu Seva Mandapam", "image_url": "/Assets/Brahmotsavam_Pavalimpu_Seva_Decoratin_3.jpg", "category": "Festival", "media_type": "PHOTO", "active_flag": True, "created_at": datetime.now(timezone.utc).isoformat()},
        {"id": str(uuid.uuid4()), "title": "Brahmotsavam - Alankara Ganapati", "image_url": "/Assets/Brahmotsavam_Alankara_Ganapati_2026.jpg", "category": "Festival", "media_type": "PHOTO", "active_flag": True, "created_at": datetime.now(timezone.utc).isoformat()},
        {"id": str(uuid.uuid4()), "title": "Brahmotsavam - Cultural Performances", "image_url": "/Assets/Brahmotsavam_Cultural_Dance_1.JPG", "category": "Festival", "media_type": "PHOTO", "active_flag": True, "created_at": datetime.now(timezone.utc).isoformat()},
        {"id": str(uuid.uuid4()), "title": "Utsava Murthulu", "image_url": "/Assets/Utsava_Murthulu_1.jpg", "category": "Festival", "media_type": "PHOTO", "active_flag": True, "created_at": datetime.now(timezone.utc).isoformat()},
    ]
